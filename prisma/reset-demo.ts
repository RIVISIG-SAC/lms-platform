...
async function cleanDatabase() {
  ...
  await prisma.$transaction([
    ...
    prisma.chapterResource.deleteMany({}),
        ...
        create: [
          {
            ...
            options: {
              create: [
                ...
                { text: "Especificar requisitos para un Sistema de Gestión de la Calidad.", isCorrect: true },
          ...
          },
          {
            ...
            options: {
              create: [
                ...
                { text: "Gestionar actividades interrelacionadas como un sistema coherente.", isCorrect: true },
          ...
          },
          {
            ...
            options: {
              create: [
                ...
                { text: "Determinar riesgos y oportunidades para lograr resultados previstos.", isCorrect: true },
